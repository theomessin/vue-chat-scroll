...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__v_chat_scroll_js__ = __webpack_require__(0);
/**
 * @name VueJS vChatScroll (vue-chat-scroll)
 * @description Monitors an element and scrolls to the bottom if a new child is added
 * @author Theodore Messinezis <theo@theomessin.com>
...
var vueChatScroll = {
  install(Vue, options) {
    Vue.directive('chat-scroll', __WEBPACK_IMPORTED_MODULE_0__v_chat_scroll_js__["a" /* default */])
  }
};
